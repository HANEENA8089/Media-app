  ...
  return (
    <>
      <div className="container mt-5 mb-3 d-flex justify-content-between">
        <h2>Watch History</h2>
        <Link style={{textDecoration:"none",color:"light",fontSize:"30px"}}to={"/home"}>Back To Home<i className='fa-solid fa-arrow-rotate-left fa-beat-fade'></i></Link>
      </div>
      <br />
      <table className='table mb-5 container shadow w-100'>
       ...
       history?.length>0?history?.map((video,index)=>(
         <tr>
            ...
            <td><button onClick={()=>removeVideoHistory(video?.id)} className='btn'><i className='fa-solid fa-trash text-danger'></i></button>
            </td>
          </tr>
